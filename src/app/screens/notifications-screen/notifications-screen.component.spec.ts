...
import { NatsMessage, NatsMessageData, NatsService } from '../../services/nats.service';
...
describe('NotificationsScreenComponent', () => {
  ...
  it('should subscribe to natsService messages$ and populate notifications', () => {
    const mockMessages = [
      {
        id: '1',
        data: { type: 'info', title: 'Test Title 1', message: 'Test Message 1', date: '2023-01-01T00:00:00Z' } as NatsMessageData,
        read: false,
        subject: 'subject1'
      },
      {
        id: '2',
        data: { type: 'error', title: 'Test Title 2', message: 'Test Message 2', date: '2023-01-02T00:00:00Z' } as NatsMessageData,
        read: true,
        subject: 'subject2'
      }
    ];
